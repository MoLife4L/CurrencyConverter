...
namespace CurrencyConverter_Database
{
    public partial class MainWindow : Window
    {
        ...
        public void mycon()
        {
            String Conn = "Data Source=LAPTOP-1LHDG5CT\\SQLEXPRESS;Initial Catalog=CurrConvDB;Integrated Security=True;Pooling=False;Encrypt=True;Trust Server Certificate=True";
